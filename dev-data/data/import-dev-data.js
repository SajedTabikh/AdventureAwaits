...
const importData = async () => {
  try {
    ...
    await User.create(users, { validateBeforeSave: false }); // Creating user documents in the database
    await Review.create(reviews); // Creating review documents in the database
