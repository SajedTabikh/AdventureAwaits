...
var isEmailValid = function isEmailValid(email) {
  var emailRegex = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.(com|net|org|edu|gov|mil|info|biz|co|us|io|me|tv|uk|ca|au|de|fr|in|it|jp|nl|nz|ru|ch|es|se|za)$/i;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _alerts.showAlert)('error', 'Invalid email address!');
        ...
        case 9:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Signup Successful. Please login with your credentials.');
            window.setTimeout(function () {
              location.assign('/login');
            }, 1500);
          }
        ...
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](0);
          errorMessage = _context.t0.response.data.message || 'Something went wrong signing up, please try again!';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // Check if the type is 'data' (updating email) before validating the email format
          if (!(type === 'data' && !isEmailValid(data.get('email')))) {
            _context.next = 5;
            break;
          }
          (0, _alerts.showAlert)('error', 'Please provide a valid email address');
          return _context.abrupt("return");
        case 5:
          _context.next = 7;
          return (0, _axios.default)({
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51NYraOCOSwPnLX5e0Q30hphsr7tfGIxrK9GwYiCeQQvI8kuQUuw070WVCVQxSLXxtYsPhnK9CnIlGl95uVOafEHP00np144YWX');
...
document.addEventListener('DOMContentLoaded', function () {
  var togglePasswordVisibility = function togglePasswordVisibility(input, icon) {
  ...
  var passwordToggles = document.querySelectorAll('.form__input-icon-btn');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7700" + '/');
